...
public class StudentHomePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Students Result Page");
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 200, 180, 30));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(135, 320, 110, 30));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(345, 320, 110, 30));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ManagmentSystem/schoolPic1.jpg"))); // NOI18N
        jLabel3.setText("jLabel3");
        jLabel3.setMaximumSize(new java.awt.Dimension(700, 600));
        jLabel3.setMinimumSize(new java.awt.Dimension(700, 600));
        jLabel3.setPreferredSize(new java.awt.Dimension(700, 600));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ResultSet rs=st.executeQuery("SELECT * FROM results WHERE RollNumber='"+rollno+"'");
            if(!rs.first()){
                 JOptionPane.showMessageDialog(null, "please enter correct rollNumber");}
            else{
